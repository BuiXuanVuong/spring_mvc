                    ...
                    <form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
                        <div class="form-group">
                            <label for="categoryCode" class="col-sm-3 control-label no-padding-right">Thể loại bài
                                viết</label>
                            <div class="col-sm-9">
                                    <%--                            <select class="col-xs-10 col-sm-5" class="form-control" id="categoryCode" name="categoryCode">--%>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="thumbnail"> Ảnh đại
                                diện </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="shortDescription" class="col-sm-3 control-label no-padding-right">Mô tả
                                ngắn</label>
                            <div class="col-sm-9">
                                    <%--                                <textarea class="form-control" rows="5" cols="10" id="shortDescription"--%>
                                    <%--                                          name="shortDescription">${model.shortDescription}</textarea>--%>
                                <form:textarea cssClass="form-control" rows="5" cols="10" path="shortDescription"
                                               id="shortDescription"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <form:textarea cssClass="form-control" rows="5" cols="10" path="content" id="content"/>
                            </div>
                        </div>
